# Архитектура базы данных KLAM.Online

## Общая концепция

KLAM.Online использует **мульти-тенантную** архитектуру с компаниями (`companies`) в качестве основного уровня изоляции данных.
